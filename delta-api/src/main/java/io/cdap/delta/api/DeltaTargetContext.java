...
public interface DeltaTargetContext extends DeltaRuntimeContext {
   ...
   * @param sequenceNumber the sequence number to be set for the first record seen by replication pipeline
   */
  default void initializeSequenceNumber(long sequenceNumber) {
